...
export const CHARGERS = ['Ipad', 'Computer', 'long usb c', 'usb micro'];

export const CABIN = ['Speaker', 'Games'];
...
export const PRETRIP_DOWNLOAD = ['Music', 'Tv', 'Movies'];

export const CAMPING_SLEEPING = [
  'Tent',
  'Air mattress',
  'Air mattress pump',
  'Sleeping bag',
...
export const SURFING = ['Surfboard', 'Sunscreen', 'Hat'];

export const ROAD_TRIP = [
  'Ac converter',
  'Usb cigarette plug',
